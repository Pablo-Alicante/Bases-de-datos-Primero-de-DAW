-- Ejercicio 20. Crea una tabla llamada Fibonacci. Inserta los 50 primeros términos de la serie mediante un procedimiento 
...
DELIMITER //
CREATE PROCEDURE ejercicio21 (IN limite INT)
BEGIN
	...
	DELETE FROM fibonacci;  -- Eliminamos las filas que pudiesen existir de pruebas anteriores
...
END //
DELIMITER ;
-- Llamamos a la función, AQUÍ ES DONDE CAMBIAMOS EL NÚMERO Y LE DECIMOS CUÁNTOS DATOS QUEREMOS QUE NOS ENSEÑE
CALL ejercicio21(10);
